...
NumPy, Pandas, Matplotlib, Scikit-learn, Django

### Machine Learning

Data preprocessing, algorithm implementation (regression and classification), overfitting and underfitting, model evaluation techniques, and a strong understanding of the mathematics used in Machine Learning models.

### Deep Learning

Data preprocessing, Artificial Neural Networks (ANN), Convolutional Neural Networks (CNN), basics of Recurrent Neural Networks (RNN) and LSTM, and model evaluation techniques.
